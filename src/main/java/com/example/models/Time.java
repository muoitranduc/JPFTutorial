...
public class Time {
	...
	public String toString() {
		return new StringBuffer(" timezone: ").append(this.timezone)
				.append(" year: ").append(this.year).append(" month: ")
				.append(this.month).append(" day: ").append(this.day)
				.append(" hour: ").append(this.hour).append(" minute: ")
				.append(this.minute).append(" second: ").append(this.second)
				.toString();
	}
}
